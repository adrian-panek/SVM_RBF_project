...
print(f"F1 score score for My Implemented Classifier is: {f1_score(y_test, MyClass_pred, average='macro')}")
print(f"Precision score for My Implemented Classifier is: {precision_score(y_test, MyClass_pred, average='macro')}")
print(f"Accuracy score for My Implemented Classifier is: {accuracy_score(y_test, MyClass_pred)}")
