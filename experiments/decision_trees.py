...
f1 = f"F1 score score for Scikit-learn Implemented Classifier is: {(round(f1_score(y_test, trees_pred, average='macro'),4))}"
prec_score = f"Precision score for Scikit-learn Implemented Classifier is: {(round(precision_score(y_test, trees_pred, average='macro'),4))}"
